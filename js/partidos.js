...
function renderAllMatches() {
    const container = document.getElementById('allMatchesContainer'); // Keep original container ID
    if (!container) return;
    ...
    displayMatches.forEach(match => {
        ...
        let mvpBadge = '';
        let goalsStr = match.GOLES ? `<div class="goalscorers">⚽ Goles: ${match.GOLES}</div>` : '';
        ...
        card.innerHTML = `
            ...
            <div class="match-content">
                <div class="match-header">
                    <span class="match-tournament">${match.torneo || 'Amistoso'}</span>
                    ${mvpBadge}
                </div>
                
                <div class="match-teams">
                    <span class="team-home">LA BUFARRA</span>
                    <span class="match-score" style="background: ${getBgScore(resultInfo.class)}">${scoreFormatted}</span>
...
function initCounter() {
    ...
    const counterEl = document.getElementById('totalMatchesCounter');
